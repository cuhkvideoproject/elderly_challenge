...
data = dict(
    videos_per_gpu=32, #original: 32, 8 gpus
    workers_per_gpu=4,
...
# optimizer
optimizer = dict(type='SGD', lr=0.4/8*2, momentum=0.9, weight_decay=0.0003)  # oriignal lr: 0.4, for 32 videos_per_gpu, with 8 gpus
