...
# optimizer
optimizer = dict(type='SGD', lr=0.4/8*2/32*16, momentum=0.9, weight_decay=0.0003)  # this lr is used for 8 gpus, 32 videos_per_gpu
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_etrifull_toyota/joint'