model = dict(
    ...
    cls_head=dict(type='GCNHead', num_classes=6, in_channels=256, loss_cls=dict(type='CrossEntropyLoss', class_weight=[1.2130928215537922, 0.5087451147312618, 0.9595314552620056, 1.1772474928366763, 1.7882889009793252, 1.3171208174714486])))

dataset_type = 'PoseDataset'
ann_file = 'data/elderlychallenge/merged_etri_full_toyota_relabel.pkl'
train_pipeline = [
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/ctrgcn/ctrgcn_pyskl_imbalance_merged_etrifull_toyota_hrnet/j'
