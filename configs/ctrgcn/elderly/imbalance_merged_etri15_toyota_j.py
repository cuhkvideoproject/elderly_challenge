model = dict(
    ...
    cls_head=dict(type='GCNHead', num_classes=6, in_channels=256, loss_cls=dict(type='CrossEntropyLoss', class_weight=[0.8913568324480927, 0.5466390287237193, 1.1067146282973621, 1.4318402171805313, 1.4438795463433711, 1.325911294666906])))

dataset_type = 'PoseDataset'
ann_file = 'data/elderlychallenge/merged_etri_1to5_toyota_relabel.pkl'
train_pipeline = [
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/ctrgcn/ctrgcn_pyskl_imbalance_merged_etri15_toyota_hrnet/j'
